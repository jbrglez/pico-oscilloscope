...
#define USB_BUF_CTRL_BUFFER_FULL_LSB 15
#define USB_BUF_CTRL_DATA_PID_LSB 13
...
#define USB_EP_CTRL_ENABLE (1u << 31u)
#define USB_EP_CTRL_INTERRUPT_PER_BUFFER (1u << 29u)
#define USB_EP_CTRL_EP_TYPE_LSB 26u
#define USB_EP_CTRL_ADDR_BASE_OFFSET_LSB 0u
